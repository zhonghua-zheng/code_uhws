...
# The results are at "/glade/scratch/zhonghua/urban_heat_train/data/"
...
def get_df(start_date, end_date, member):
    ...
    print(df_var.shape)
    df_var.to_csv("/glade/scratch/zhonghua/urban_heat_train/data/"+member+"_"+start_date[:4]+"_"+end_date[:4]+".csv")
