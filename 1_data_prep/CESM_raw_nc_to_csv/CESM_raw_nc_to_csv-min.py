...
# The results are at "/glade/scratch/zhonghua/CESM-LE-members-csv-min/"
...
def get_df(start_date, end_date, member):
    ...
    print(df_var.shape)
    df_var.to_csv("/glade/scratch/zhonghua/CESM-LE-members-csv-min/"+member+"_"+start_date[:4]+"_"+end_date[:4]+".csv")
