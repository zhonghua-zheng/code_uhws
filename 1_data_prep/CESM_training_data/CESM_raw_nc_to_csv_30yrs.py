...
# The results are at "/glade/scratch/zhonghua/ensem_training_data/2061_30yrs.csv"
...
del df_ls
gc.collect()
df_final.to_csv("/glade/scratch/zhonghua/ensem_training_data/2061_30yrs.csv") # 30 yrs data