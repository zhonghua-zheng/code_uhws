...
def XGB_apply(df,start_date,lat,lon,model_name):
    ...
    XGBreg = pickle.load(open("/glade/scratch/zhonghua/ensem_model_min/"+start_date+"/"+"MX_"+lat+"_"+lon+".dat","rb"))
...
for lat in lat_lon_dict:
    ...
    for lon in lat_lon_dict[lat]:
        ...
        if (i%10==0):
            print(i)
pd.concat(df_final_ls).to_csv("/glade/scratch/zhonghua/CMIP5_pred_min/"+start_date+"/"+model_name+".csv")